...
import (
	...
	"github.com/mongodb/mongo-tools/common/bson/internal/testutil"
...
func validateRelaxedExtendedJSON(t *testing.T, rEJ string, bsonType string) {
	...
	// Need this as without this JSON.unmarshal will see a JSON Number and it will convert that into a float64
	// Then I have no idea whether the user wanted a floating point number 1.0 or an integer 1.
	if bsonType == "0x12" || bsonType == "0x10" { // Int32 and Int64 types.
